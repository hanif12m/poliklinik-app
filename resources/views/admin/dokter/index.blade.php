<x-layouts.app title="Data Dokter">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.dokter.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary/90 
                        ...
                        <tr class="border-b border-slate-100 hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    {{-- Edit --}}
                                    <a href="{{ route('admin.dokter.edit', $dokter->id) }}" class="inline-flex items-center gap-1 px-3 py-2 
