<x-layouts.app title="Tambah Dokter">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('admin.dokter.index') }}" class="flex items-center justify-center w-9 h-9 rounded-lg 
        ...
        <div class="card-body p-8">
            ...
            <form action="{{ route('admin.dokter.store') }}" method="POST">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.dokter.index') }}" class="inline-flex items-center gap-2 px-6 py-2.5
                              bg-slate-100 hover:bg-slate-200
